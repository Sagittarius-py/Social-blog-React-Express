...
INSERT INTO `users` (`id_user`, `userName`, `postCount`, `likesCount`, `access_lvl`, `about`, `password`, `profilePic`) VALUES
(29, 'Filip', 10, 7, 3, 'Cokolwiek', 'Sieniawski', 'division2_orange.png'),
(30, 'Kuba', 1, 2, 1, 'Bobak', 'Bobak', 'ac4_Wallpaper2_1920x1080.jpg'),
(32, 'Maciek', 3, 1, 3, 'Cokolwiek', 'Tabor', 'china-guangxi-guilin-li-river-wallpaper-6826ddd8d0b0ac88f0cc11fe68a2849a.jpg'),
(39, 'awd', 0, 0, 2, 'awd', 'awd', '1676989805961873765.jpg');
...
--
ALTER TABLE `photos`
  MODIFY `photo_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=156;

--
-- AUTO_INCREMENT dla tabeli `posts`
--
ALTER TABLE `posts`
  MODIFY `post_id` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=214;
